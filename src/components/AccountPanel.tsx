 ...
 * selector hooks. See sister-site oriz-home for the rationale (the upstream
 * package can't be resolved via GitHub tarball until it ships to npm).
 *
 * Hooks are the contract; this file is just one implementation. Site palette
 * is applied via src/styles/oriz-ui-overrides.css.
 */
import {
  GithubAuthProvider,
  GoogleAuthProvider,
    ...
    return (
      <div data-oriz-account data-oriz-account-state="signed-in">
        ...
        <p data-oriz-account-note>
          ...
          there. Your name appears embossed on every card preview while you browse.
        </p>
        <button
          type="button"
